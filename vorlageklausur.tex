...
% generisches Feminin schließt selbstverständlich auch männliche Personen ein
% -----------------------------------------------------------------------------
...
\usepackage{ngerman, scrpage2, amsmath, amsthm,amssymb} %  calc,
...
\cfoot{\scriptsize Grammatikalisch
feminine Formen von Personenbezeichnungen schließen alle Personen gleichermaßen
ein.}
\setfootsepline{.5pt}
...
\hline
  ...
  \begin{tabular*}{\linewidth}{l@{\extracolsep\fill}r}
    ...
    \ifdefined\Prueferin Prüferin:&\Prueferin\\\fi
    \ifdefined\Beisitzerin Beisitzerin:&\Beisitzerin\\\fi
    \ifdefined\Kursassistentin Kursassistenz:&\Kursassistenz\\\fi
...
\begin{enumerate}
  \item Aufgabentext der ersten Aufgabe. Nummerierung passiert automatisch.
  \begin{enumerate}
    \item Aufgabenteil a) der ersten Aufgabe. Nummerierung mit a), b), ... passiert automatisch.
    \begin{align*}
